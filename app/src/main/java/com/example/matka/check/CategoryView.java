...
public class CategoryView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.CategoryView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.CategoryView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.CategoryView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.CategoryView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.CategoryView_exampleDrawable);
